defmodule BlogAppWeb.ArticleLiveTest do
  use BlogAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import BlogApp.ArticlesFixtures

  @create_attrs %{body: "some body", status: 42, submit_date: "2023-05-16", title: "some title"}
  @update_attrs %{body: "some updated body", status: 43, submit_date: "2023-05-17", title: "some updated title"}
