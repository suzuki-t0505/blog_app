defmodule BlogAppWeb.AccountAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_blog_app_web_account_remember_me"
  ...
  the current_account:
      ...
      defmodule BlogAppWeb.PageLive do
        ...
        on_mount {BlogAppWeb.AccountAuth, :mount_current_account}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{BlogAppWeb.AccountAuth, :ensure_authenticated}] do
