defmodule BlogApp.Articles do
  ...
  def list_articles do
    ...
    |> Repo.all()
    |> Enum.map(fn article -> set_like_count(article) end)
  end
  ...
  def search_articles_by_keywords(keyword) do
    keyword = "%#{keyword}%"
  ...
  defp set_like_count(%Article{likes: likes} = article) do
    %{article | like_count: Enum.count(likes)}
  end
  ...
  def liked_article(article_id, account_id) do
    %Like{}
